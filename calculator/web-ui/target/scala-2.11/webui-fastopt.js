...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  matchEnd19: {
    var res;
    if ($is_Lcalculator_Plus(expr)) {
      var x2 = $as_Lcalculator_Plus(expr);
      var a = x2.a$2;
      var b = x2.b$2;
      if ((a !== null)) {
        if ((b !== null)) {
          var res = (this.eval__Lcalculator_Expr__sci_Map__D(a, references) + this.eval__Lcalculator_Expr__sci_Map__D(b, references));
          break matchEnd19
        }
      }
    };
    if ($is_Lcalculator_Minus(expr)) {
      var x3 = $as_Lcalculator_Minus(expr);
      var a$2 = x3.a$2;
      var b$2 = x3.b$2;
      if ((a$2 !== null)) {
        if ((b$2 !== null)) {
          var res = (this.eval__Lcalculator_Expr__sci_Map__D(a$2, references) - this.eval__Lcalculator_Expr__sci_Map__D(b$2, references));
          break matchEnd19
        }
      }
    };
    if ($is_Lcalculator_Times(expr)) {
      var x4 = $as_Lcalculator_Times(expr);
      var a$3 = x4.a$2;
      var b$3 = x4.b$2;
      if ((a$3 !== null)) {
        if ((b$3 !== null)) {
          var res = (this.eval__Lcalculator_Expr__sci_Map__D(a$3, references) * this.eval__Lcalculator_Expr__sci_Map__D(b$3, references));
          break matchEnd19
        }
      }
    };
    if ($is_Lcalculator_Divide(expr)) {
      var x5 = $as_Lcalculator_Divide(expr);
      var a$4 = x5.a$2;
      var b$4 = x5.b$2;
      if ((a$4 !== null)) {
        if ((b$4 !== null)) {
          var res = (this.eval__Lcalculator_Expr__sci_Map__D(a$4, references) / this.eval__Lcalculator_Expr__sci_Map__D(b$4, references));
          break matchEnd19
        }
      }
    };
    if ($is_Lcalculator_Literal(expr)) {
      var x6 = $as_Lcalculator_Literal(expr);
      var v = x6.v$2;
      var res = v;
      break matchEnd19
    };
    if ($is_Lcalculator_Ref(expr)) {
      var x7 = $as_Lcalculator_Ref(expr);
      var name = x7.name$2;
      if ((name !== null)) {
        var res = this.eval__Lcalculator_Expr__sci_Map__D(this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references), references);
        break matchEnd19
      }
    };
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      ...
      var r1 = (((-jsx$1) + $uD($g["Math"]["sqrt"](a$1))) / (2 * $uD(a$2.apply__O())));
      ...
      var r2 = (((-jsx$2) - $uD($g["Math"]["sqrt"](a$3))) / (2 * $uD(a$2.apply__O())));
      var array = [r1, r2];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var x = $as_T(x0$1.$$und1$f);
    var y = $as_Lcalculator_Signal(x0$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, y$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(y$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, y));
    return new $c_T2().init___O__O(x, new $c_Lcalculator_Signal().init___F0(expr))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
